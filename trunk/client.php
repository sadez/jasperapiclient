<?php
	$webservices_uri = "http://127.0.0.1:8080/jasperserver/services/repository";
	$webservices_uri = "https://reports.teladoc.com/services/repository";
	...
	function ws_list($uri, $args = array())
	{
		...
		$connection_params = array("user" => $HTTP_SESSION_VARS["username"], "pass" => $HTTP_SESSION_VARS["password"]);
		$info = new SOAP_client($GLOBALS["webservices_uri"], false, false, $connection_params);
	...
	function ws_runReport($uri, $report_params, $output_params, &$attachments )
	{
		...
		$connection_params = array("user" => $HTTP_SESSION_VARS["username"], "pass" => $HTTP_SESSION_VARS["password"], "timeout" => $max_execution_time);
		$info = new SOAP_client($GLOBALS["webservices_uri"], false, false, $connection_params);
